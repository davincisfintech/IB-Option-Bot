...
screened data will be stored in scanned_data table and trades data will be stored in trades_data table

*** Parameters  ***
for only running screener:
    Provide parameters in screener_1.py file as specified in it
for running screener + IB client:
    Provide parameters in main.py file as specified in it
...
Option 1:
    ...
    for only running screener:
        set screener_1.py located in main folder in pycharm configuration and click on run button to run program
    for running screener + IB client:
...
Option 2:
    ...
    for MacOs/Linux:
          ...
          for only running screener:
            python screener_1.py.py   # Run program
          for running screener + IB client:
